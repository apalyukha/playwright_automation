...
def preconditions(request):
    """Global fixtures. Run automatically before all tests and executes part
    before yield statement as test precondition. Executes code after yield
    statement after last test executed as test post conditions.
    ...
    https://docs.pytest.org/en/6.2.x/reference.html#std-fixture-request
     :param request: pytest fixture
    https://docs.pytest.org/en/6.2.x/reference.html#std-fixture-
     :param request: pytest fixture
    https://docs.pytest.org/en/6.2.x/reference.html#std-fixture-
         request :param request: pytest fixture
    https://docs.pytest.org/en/6.2.x/reference.html#std-fixture-
    :param request: pytest fixture
        https://docs.pytest.org/en/6.2.x/reference.html#std-fixture-
        request
...
def get_web_service(request):
    """Fixture returns authenticated WebService object to work with tested app
...
@fixture(scope="session")
def get_playwright():
    """Returns single instance of playwright itself :return:"""
...
def pytest_addoption(parser):
    ...
    parser.addini(
        "base_url", help="base url of site under test", default="http://127.0.0.1:8000"
    )
    parser.addini(
        "db_path",
        help="path to sqlite db file",
        default="/home/apalyukha/Projects/test_me_tcm/db.sqlite3",
    )
